"""
Django settings for dynamic_db project.
...
SECRET_KEY = 'django-insecure-vw0p73vr6z92dy1-)gsmj57!uge4v!b7h6p!3y3kdes!=z(j#x'
...
MIDDLEWARE = [
    ...
    'dynamic_db.middleware.RouterMiddleware',
]

ROOT_URLCONF = 'dynamic_db.urls'
...
WSGI_APPLICATION = 'dynamic_db.wsgi.application'
